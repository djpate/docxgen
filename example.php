...
$phpdocx->assignNestedBlock("toys",array("#TOYNAME#"=>"Frisbee"),array("members"=>1,"pets"=>1)); // would create a block toy for rex
$phpdocx->assignNestedBlock("toys",array("#TOYNAME#"=>"Box"),array("members"=>1,"pets"=>1)); // would create a block toy for rex
